	...
	echo '
		<style type="text/css" media="screen">
			...
			#catapult-cookie-bar h3 {
				...
				color: #03C6C6;
				text-align: center;
				border-bottom: 1px dotted #03C6C6;
				line-height: 1.5em;
			}
...
function catapult_add_cookie_bar() {
	...
	if ( $options['catapult_cookie_text_settings'] ) {
		...
		$current_text = "The cookies which we use on this site record information about your online preferences, remember information about you when you visit our site and compile statistical reports on website activity. Some of the cookies we use are essential in order for us to provide our services and the website to you. By clicking 'I Agree' or by continuing to use our site you are consenting to our use of cookies in accordance with our cookies policy.";
	}
	...
	$content = sprintf( '<div id="catapult-cookie-bar"><h3>Our Cookie Policy</h3><p>%s</p><button id="catapultCookie" tabindex=1 onclick="catapultAcceptCookies();">%s</button><a tabindex=1 href="%s">%s</a></div>', htmlspecialchars( $current_text ), htmlspecialchars( $accept_text ), home_url( $link_text ), htmlspecialchars( $more_text ) );
