	  		...
	  		<?php if (is_tree(236)) { 
		  		...
		  		<div class="col-sm-2">
		  			<div class="contact_side">
						...
						<h6>Call us: <strong>0800 7723147</strong></h6>
						<p>OR<br>
						</p><h6><a href="<?php echo site_url(); ?>/request-a-no-obligation-assessment/" title="Request a No-Obligation Assessment">Click Here</a> to fill out your details.</h6>
